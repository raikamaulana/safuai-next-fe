...
export const TokenInformation = () => {
    return (
        <div className="bg-customLightBg dark:bg-customDark min-h-screen overflow-hidden">
            <div className="flex justify-center">
                    <div className="bg-white dark:bg-customDarkComp mt-14 mb-8 rounded-md p-6 mr-2">
                        <p className="text-customPurple font-[Poppins] mb-5 text-xl mt-2 ml-4 font-semibold">Token Information</p>
                        <div className='flex justify-between border-2 border-customLightBg dark:border-none dark:bg-customDarkTr mx-auto rounded-lg p-1'>
                        ...
                        <div className='flex justify-between border-2 border-customLightBg dark:border-none dark:bg-customDarkTr mt-4 mx-auto rounded-lg p-1'>
                    ...
                    <p className="text-custborder-customPurple font-[Poppins] mb-5 text-xl mt-2 ml-4 font-semibold">Owner & Deployer Information</p>
                    <div className='flex justify-between border-2 border-customLightBg dark:border-none dark:bg-customDarkTr mx-auto rounded-lg p-1'>
                    ...
                    <div className="bg-white dark:bg-customDarkComp p-6 ml-2 rounded-md pb-8">
                        <div className="flex ">
                            ...
                            <div className="flex justify-between border-2 border-customLightBg dark:border-none dark:bg-customDarkTr p-1 rounded-md mb-5">
                            ...
                            <div className="flex justify-between border-2 border-customLightBg dark:border-none dark:bg-customDarkTr p-1 rounded-md">
