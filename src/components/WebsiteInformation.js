...
export const WebsiteInformation = () => {
  return (
    <div className="dark:bg-customBlack bg-transparent overflow-hidden ">
      <div className="flex dark:text-white">
        <div className="min-w-max">
          <div className="font-poppins">
            <p className="font-semibold text-xl mb-6">
              https://www.toonsbox.io
            </p>
          ...
          <div className="dark:bg-gray-875 bg-white flex justify-between font-poppins pb-7 rounded-sm">
            <div>
              <p className="my-5 ml-9 font-semibold">Website Stats Chart</p>
              {/* <button onClick={changePages}> */}
              <Image
                src="/images/website-stats-chart.png"
                alt=""
                width={368}
                height={276}
              ...
              />
              <Image
                src="/images/website-stats-chart-black.png"
                alt=""
                width={368}
                height={276}
