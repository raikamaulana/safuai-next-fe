    ...
    <div className="dark:bg-[#1B1F28] bg-[#E8ECEF] min-h-screen overflow-hidden transition-all duration-500">
              ...
              {Auditinfo.map((audits, id) => (
                ...
                >
                  ...
                  <Link href={audits.link}>
                    <p className="dark:text-white font-medium text-black md:mt-3 md:ml-5 -mr-10 ml-3 mt-2 md:text-lg text-base flex">
                      {" "}
                      {audits.number}
                    </p>
                    <Image
      ...
      <div className="pb-28 mx-auto">
        <div className="pt-36 flex justify-center">
          <div className="md:space-x-6 space-x-12 md:-translate-x-7 lg:translate-x-0 dark:lg:translate-x-6 dark:md:-translate-x-7 pl-7">
            <div className="flex md:ml-1 ml-36">
              <p className="dark:text-white text-black font-medium md:text-2xl text-xl pt-3 md:ml-8 md:mr-4">
              ...
              <a
                ...
                className="md:ml-32 mt-4 md:mt-0 ml-2 mr-40 md:-mr-20 mb-14"
              >
                <button className="dark:bg-gray-[#1B1F28] dark:hover:bg-gray-800 hover:bg-gray-500 outline dark:outline-gray-700 outline-gray-600 duration-200 text-white text-sm md:px-8 p-1 px-5 md:py-4 rounded-md md:mr-10 -pl-10">
            ...
            <div className="mx-auto mb-20">
              <div className="md:-mb-10 -mb-16 justify-center md:space-x-9 lg:space-x-8 space-x-2 md:mr-0 mr-14 flex">
            ...
            <div className="mt-20 md:pr-0 pr-40">
              {Auditinfosecond.map((auditsec, id) => (
                <div
                  key={id}
                  className="py-4 mt-3 pt-1 md:pr-24 pr-2 md:ml-0 ml-20 pl-10 md:pl-0  dark:bg-[#1B1F28] bg-[#FFFFFF] outline dark:outline-[#363D4C] outline-gray-600"
                >
                  <div className="-ml-8 md:-ml-0 mx-auto w-80 md:w-full">
                  <button>
                    <p className="dark:text-white font-medium text-black md:mt-3 md:ml-5 -mr-10 ml-3 mt-2 md:text-lg text-base flex">
