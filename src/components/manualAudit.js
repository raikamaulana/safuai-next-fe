  ...
  return (
    <>
      <div className="text-black dark:text-white transition-all duration-500">
        <div className='max-w-3xl min-h-[800px] bg-white dark:bg-customDarkComp py-4 px-4 font-[Poppins] font-normal'>
          <Tab.Group defaultIndex={0}>
              ...
              <Tab className={({ selected }) =>
                classNames(
                  ...
                  selected
                    ...
                    : 'dark:hover:border hover:border-2 hover:border-customPurple hover:bg-customWhite/20 hover:text-black dark:hover:bg-white/[0.2] dark:hover:text-white'
                )
              }>MINOR (1)</Tab>
              <Tab className={({ selected }) =>
                classNames(
            ...
            <Tab.Panels>
              <Tab.Panel>
                <div className='max-w-3xl min-h-[702px] text-base mt-4 px-6 py-4 border border-customWhite dark:border-none bg-white dark:bg-customSecondGray'>
                  ...
                  <div className='min-h-[556px] px-5 py-4 mt-5 dark:border dark:border-white border border-customWhite rounded-lg overflow-x-scroll lg:overflow-hidden'>
              ...
              <Tab.Panel>
                <div className='max-w-3xl min-h-[702px] text-base mt-4 px-6 py-4 border border-customWhite dark:border-none bg-white dark:bg-customSecondGray'>
                  ...
                  <div className='min-h-[475px] px-5 py-4 mt-5 dark:border dark:border-white border border-customWhite rounded-lg overflow-x-scroll lg:overflow-hidden'>
                    <div className='w-[630px]'>
              ...
              <Tab.Panel>
                <div className='max-w-3xl min-h-[702px] text-base mt-4 px-6 py-4 border border-customWhite dark:border-none bg-white dark:bg-customSecondGray'>
                  ...
                  <div className='min-h-[605px] px-5 py-4 mt-5 dark:border dark:border-white border border-customWhite rounded-lg overflow-x-scroll lg:overflow-hidden'>
                  </div>
                </div>
              </Tab.Panel>
              <Tab.Panel>
              ...
              <Tab.Panel>
                <div className='max-w-3xl min-h-[702px] text-base mt-4 px-6 py-4 border border-customWhite dark:border-none bg-white dark:bg-customSecondGray'>
                  ...
                  <div className='min-h-[183px] px-5 py-4 mt-5 dark:border dark:border-white border border-customWhite rounded-lg overflow-x-scroll lg:overflow-hidden'>
                  </div>
                  <div className='mt-8'>
