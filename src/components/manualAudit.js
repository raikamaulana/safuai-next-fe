  ...
  return (
    <>
      <div className="text-black dark:text-white transition-all duration-500">
        <div className='max-w-3xl min-h-[800px] bg-white dark:bg-customBlack py-4 px-4 font-[Poppins] font-normal'>
          <Tab.Group defaultIndex={0}>
            <Tab.List className='gap-4 overflow-x-scroll lg:overflow-hidden grid grid-flow-col w-full'>
              <Tab className={({ selected }) =>
                classNames(
                  'w-32 bg-customLight dark:bg-customSecondGray py-3 text-base',
                  'focus:outline-none',
                  selected
                    ? 'dark:border border-2 border-customPurple text-customPurple bg-white shadow'
                    : 'dark:hover:border hover:border-2 hover:border-customPurple hover:bg-customLight/20 hover:text-black dark:hover:bg-white/[0.2] dark:hover:text-white'
                )
              }>MINOR (1)</Tab>
              <Tab className={({ selected }) =>
                classNames(
                  'w-36 lg:w-32 bg-customLight dark:bg-customSecondGray py-3 text-base',
                  'focus:outline-none',
                  selected
                    ? 'dark:border border-2 border-customPurple text-customPurple bg-white shadow'
                    : 'dark:hover:border hover:border-2 hover:border-customPurple hover:bg-customLight/20 hover:text-black dark:hover:bg-white/[0.2] dark:hover:text-white'
              ...
              <Tab className={({ selected }) =>
                classNames(
                  'w-28 bg-customLight dark:bg-customSecondGray py-3 text-base',
                  'focus:outline-none',
                  selected
                    ? 'dark:border border-2 border-customPurple text-customPurple bg-white shadow'
                    : 'dark:hover:border hover:border-2 hover:border-customPurple hover:bg-customLight/20 hover:text-black dark:hover:bg-white/[0.2] dark:hover:text-white'
              ...
              <Tab className={({ selected }) =>
                classNames(
                  'w-44 bg-customLight dark:bg-customSecondGray py-3 text-base',
                  'focus:outline-none',
                  selected
                    ? 'dark:border border-2 border-customPurple text-customPurple bg-white shadow'
                    : 'dark:hover:border hover:border-2 hover:border-customPurple hover:bg-customLight/20 hover:text-black dark:hover:bg-white/[0.2] dark:hover:text-white'
            ...
            <Tab.Panels>
              <Tab.Panel>
                <div className='max-w-3xl min-h-[702px] text-base mt-4 px-6 py-4 border border-customLight dark:border-none bg-white dark:bg-customSecondGray'>
                  ...
                  <div className='min-h-[556px] px-5 py-4 mt-5 dark:border dark:border-white border border-customLight rounded-lg overflow-x-scroll lg:overflow-hidden'>
              ...
              <Tab.Panel>
                <div className='max-w-3xl min-h-[702px] text-base mt-4 px-6 py-4 border border-customLight dark:border-none bg-white dark:bg-customSecondGray'>
                  ...
                  <div className='mt-2'>
                    <h2 className='mb-1 font-medium'>1. <span className='text-customPurple'>Add Liquidity</span></h2>
                  ...
                  <div className='min-h-[475px] px-5 py-4 mt-5 dark:border dark:border-white border border-customLight rounded-lg overflow-x-scroll lg:overflow-hidden'>
                    <div className='w-[630px]'>
              ...
              <Tab.Panel>
                <div className='max-w-3xl min-h-[702px] text-base mt-4 px-6 py-4 border border-customLight dark:border-none bg-white dark:bg-customSecondGray'>
                  ...
                  <div className='min-h-[605px] px-5 py-4 mt-5 dark:border dark:border-white border border-customLight rounded-lg overflow-x-scroll lg:overflow-hidden'>
                  </div>
                </div>
              </Tab.Panel>
              <Tab.Panel>
              ...
              <Tab.Panel>
                <div className='max-w-3xl min-h-[702px] text-base mt-4 px-6 py-4 border border-customLight dark:border-none bg-white dark:bg-customSecondGray'>
                  <div className=''>
                    <h1><span className='text-customPurple'>1. Informational</span> - No need fixed, and will not bring problems.</h1>
                  ...
                  <div className='min-h-[183px] px-5 py-4 mt-5 dark:border dark:border-white border border-customLight rounded-lg overflow-x-scroll lg:overflow-hidden'>
                  </div>
                  <div className='mt-8'>
