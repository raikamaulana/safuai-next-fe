...
export const HolderTaken = () => {
  return (
    <div className="dark:bg-[#1B1F28] bg-[#E8ECEF] min-h-screen lg:px-40 pt-36 py-10 flex transition-all duration-500 overflow-hidden">
      <div className="dark:bg-[#2C3239] bg-white lg:mx-56 sm:mx-24 pt-3 pb-20">
