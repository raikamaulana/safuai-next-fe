                ...
                <div className="px-4 py-4 mx-auto lg:px-28 md:px-12 sm:px-8 md:py-0 lg:py-0 xl:py-0">
                    <div className="flex items-center justify-between md:justify-between md:space-x-4">
                        ...
                        <div className="flex items-center gap-2 -mr-2 lg:hidden">
                            ...
                            <Popover.Button className="relative inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-lg dark:bg-gray-800 hover:black hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
