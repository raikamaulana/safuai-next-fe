...
import { RiFileCopy2Line, RiFilePdfFill, RiFilePdfLine, RiGalleryFill } from "react-icons/ri";
        ...
        <div>
            {web3Provider ? (
                <button
                    ...
                    className={
                        "rounded-lg text-white bg-blue-500 border-2 border-blue-500 px-1 py-1 md:px-3 md:py-2 lg:px-3 lg:py-2"
                    }
                >
            ...
            {dropdownOpen && (
                <div className="absolute p-6 mt-2 bg-white rounded-md shadow-lg w-max">
                    <p className="mb-2 text-sm text-gray-600">Address: {getSimpleAddress(address ? address : "")}</p>
...
export function Header() {
    ...
    return (
        <>
            <Popover className="fixed z-20 w-full bg-white/80 backdrop-blur dark:bg-gray-900">
                <div className={scrolled ? 'hidden' : 'block px-6 py-2 text-white bg-blue-500'}>
                    <marquee>
                        <div className="flex items-center gap-3">
                            ...
                            <div>Best Price for all high quality security products</div>
                        </div>
                    </marquee>
                </div>
                <div className="px-4 py-4 mx-auto lg:px-28 md:px-12 sm:px-8 md:py-0 lg:py-0 xl:py-0">
                    <div className="flex items-center justify-between md:justify-between md:space-x-4">
                        <div className="flex items-center justify-start gap-2">
                            <Link
                                ...
                                className={
                                    activ === '/'
                                        ? "text-blue-500 font-medium mr-6 flex items-center gap-1"
                                        : "text-gray-900 dark:text-white font-medium flex items-center gap-1"
                                }
                                aria-label="logo this"
                            >
                                {colorTheme === "dark" ? (
                                    <Image src="/images/logo-dark.svg" width="140" height="39" alt="" />) : (
                                    <Image src="/images/logo-white.svg" width="140" height="39" alt="" />
                                )}
                            </Link>
                        </div>
                        <div className="flex items-center gap-2 -mr-2 lg:hidden">
                            <Menu as="div" className="relative inline-block py-2 text-left md:p-2">
                            ...
                            <Popover.Button className="relative inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md rounded-lg dark:bg-gray-800 hover:black hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                        ...
                        <Popover.Group as="nav" className="hidden space-x-8 lg:flex">
                            <Link
                                ...
                                className={activ === '/'
                                    ?
                                    "text-blue-500 font-medium bg-tear bg-no-repeat py-5 active"
                                    ...
                                    <>
                                        <Popover.Button
                                            className={classNames(
                                                open
                                                    ? "text-blue-500 font-medium py-5"
                                                    : "dark:text-white black py-5",
                                                "group rounded-md inline-flex items-center text-base font-medium hover:text-gray-900",
                                                pathname.match('/request') || pathname.match('/audit-list') || pathname.match('/kyc-list') || pathname.match('/bounty-scammers') || pathname.match('/token-scanner') || pathname.match('/nft-scanner') ? "bg-tear bg-no-repeat bg-top" : ""
                                            )}
                                        >
                                            <span>Products</span>
                                            <FaAngleDown
                                ...
                                {({ open }) => (
                                    <>
                                        <Popover.Button
                                            className={classNames(
                                                open
                                                    ? "text-gray-900 dark:text-blue-500 py-5"
                                                    : "dark:text-white black py-5",
                                                "group rounded-md inline-flex items-center text-base font-medium hover:text-gray-900",
                                                pathname.match('/security-audit') || pathname.match('/kyc') || pathname.match('/blog') || pathname.match('/how-to-use') ? "bg-tear bg-no-repeat bg-top" : ""
                                            )}
                                        >
                                            <span>Knowledge</span>
                                            <FaAngleDown
                                        ...
                                        <Popover.Button
                                            className={classNames(
                                                open
                                                    ...
                                                    : "dark:text-white black py-5",
                                                "group rounded-md inline-flex items-center text-base font-medium hover:text-gray-900",
                                                pathname.match('/about') || pathname.match('/team') || pathname.match('/disclaimer') || pathname.match('/privacy-policy') ? "bg-tear bg-no-repeat bg-top" : ""
                                            )}
                                        >
                                            <span>Company</span>
                                            <FaAngleDown
                            ...
                            <a
                                ...
                                className="py-5 font-medium text-gray-900 dark:text-white"
                            >
                                Token
                            </a>
                        </Popover.Group>
            ...
            <div className="relative overflow-x-scroll bg-white dark:bg-gray-900">
                <div className="px-4 md:px-8 lg:px-24">
                    <div className="flex items-center w-full gap-2 px-0 py-2 md:px-3 lg:px-3 whitespace-nowrap">
                        <Link
                            className={dynamicId === "safetyScore"
                        ...
                        >Safety Score</Link>
                        <Link
                            className={dynamicId === "taxInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                            href="#taxInformation"
                        ...
                        <Link
                            className={dynamicId === "overviewInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                        ...
                        <Link
                            className={dynamicId === "auditInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                        ...
                        >Audit Overview</Link>
                        <Link
                            className={dynamicId === "manualInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                        ...
                        <Link
                            className={dynamicId === "marketInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                        ...
                        <Link
                            className={dynamicId === "contractInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                            href="#contractInformation"
                        >Contract Inheritance</Link>
                        <Link
                            className={dynamicId === "websiteInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                        ...
                        <Link
                            className={dynamicId === "liquidityInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                            href="#liquidityInformation"
                        >Liquidity & Holder</Link>
                        <Link
                            className={dynamicId === "autoInformation"
                                ? 'bg-gray-300 dark:bg-gray-800 dark:text-gray-400 py-2 px-4 rounded-md text-gray-900 font-semibold'
                                : 'bg-white py-2 dark:bg-gray-900 px-4 rounded-md text-gray-600 dark:text-gray-500 font-semibold'}
                            scroll={true}
                            href="#autoInformation"
                        >Automatic Vulnerability Scan</Link>
                        <div className="px-4 py-2 text-gray-900 bg-white rounded-md">
                        </div>
                        <div className="px-4 py-2 text-gray-900 bg-white rounded-md">
                        </div>
                        <div className="px-4 py-2 text-gray-900 bg-white rounded-md">
                    ...
                    <div className="grid lg:grid-cols-4 sm:grid-cols-2 lg:gap-0 gap-y-6">
                        <div className="">
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <a
                                        href="https://medium.com/@blocksafu"
                                        className="px-3 py-3 text-black bg-white rounded-md dark:bg-gray-900 dark:text-white"
                                        aria-label="medium"
                                    >
                                        <svg
                        ...
                        <div className="pl-1 md:pl-12 lg:pl-10">
                            ...
                            <ul className="space-y-2 text-black dark:text-gray-200">
                                ...
                                <li>
                                    <a href="https://token.blocksafu.com/documents">Documents</a>
                                </li>
                                <li>
                                    <a href="https://token.blocksafu.com/team">Teams</a>
                                </li>
                            </ul>
                        </div>
                        <div className="pl-1 md:pl-0 lg:pl-10">
                            ...
                            <ul className="space-y-2 text-black dark:text-gray-200">
                                <li>
                                    <a href="https://t.me/blocksafuofficial">Telegram Group</a>
                                </li>
                                <li>
                                    <a href="https://t.me/blocksafuannouncement">
                                        Telegram Channel
                                    </a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/blocksafu">Twitter</a>
                                </li>
                                <li>
                                    <a href="https://token.blocksafu.com/privacy">
                                        Privacy Policy
                                    </a>
                                </li>
                                <li>
                        ...
                        <div className="pl-1 md:pl-12 lg:pl-10">
                            ...
                            <ul className="space-y-5 text-black dark:text-gray-200">
                                <li>
                                    <a href="mailto:marketing@blocksafu.com" className="flex">
                                        <FaEnvelope className="w-6 h-6 mr-2" /> For Support <br />
                                        support@blocksafu.com
                                    </a>
                                </li>
                                <li>
                                    <a href="mailto:blocksafu@gmail.com" className="flex">
                                        <FaEnvelope className="w-6 h-6 mr-2" /> Google Mail
                                        <br />
                                        blocksafu@gmail.com
                                    </a>
                                </li>
                    ...
                    <div className="mx-auto border-color">
                        ...
                        <div className="container flex flex-col items-center pt-12 mx-auto space-y-5 lg:flex-row lg:space-y-0">
                            <nav className="flex flex-col items-center justify-center text-black dark:text-white lg:flex-row">
                                <p>Copyright © 2022 Blocksafu. All rights reserved.</p>
                            </nav>
                        </div>
                    </div>
                </footer>
