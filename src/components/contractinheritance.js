          ...
          <div>
            ...
            <div className="flex">
              <Image
                width="88"
                height="94"
                className="lg:rotate-0 md:rotate-0 -rotate-12 lg:mr-16 md:mr-16 mx-auto"
              ...
              <Image
                width="135"
                height="101"
                className="lg:rotate-0 md:rotate-0 rotate-45 mb-2 h-20 lg:h-auto md:h-auto mt-6 lg:mt-0 md:mt-0 mx-auto"
