    ...
    return (
        <>
            <div className="pt-44 pb-28 px-4 sm:px-8 md:px-12 lg:px-28 bg-[#E8ECEF] dark:bg-[#1B1F28] text-black dark:text-white transition-all duration-500">
                {/* DIV 1 */}
                <div className="w-20 rounded-md bg-white dark:bg-[#26293A] px-5 py-1">
                    <p className="font-[Inter] font-light text-base">Audit</p>
                </div>
                {/* DIV 2 */}
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 mt-6 w-full">
                    ...
                    <div className="w-full pl-5 py-5 rounded-md dark:border-none bg-white dark:bg-[#26293A]">
                        <div className="flex gap-3 items-center">
                            ...
                            <p className="flex justify-center items-center w-20 h-9 rounded-md border border-[#5B4C7C]">VR</p>
                        </div>
                        <div className="mt-5 flex flex-wrap gap-3">
                            <p className="w-48 h-9 flex items-center text-left pl-6 bg-gray-300 dark:bg-[#1A1D2F] rounded-md border border-[#5B4C7C] font-[Inter] text-base font-normal dark:font-light">Audit Release #1</p>
                    ...
                    <div className="w-full px-5 py-6 rounded-md dark:border-none bg-white dark:bg-[#26293A] flex justify-center gap-5">
                        <div className="w-full mt-2">
                            <p className="text-center font-[Inter] font-medium text-lg leading-4">Content Score</p>
                            <Image src="/images/auditrelease/auditmeter.svg" width="100" height="100" className="mx-auto mt-5 sm:mt-4"/>
                            <p className="text-center font-[Inter] font-medium text-lg"><span className="text-xl text-[#D171FF]">75</span>/100</p>
                        ...
                        <div className="w-full mt-2">
                            ...
                            <div className="mx-auto grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-3 w-full sm:w-52 lg:w-full mt-4 gap-5">
                                ...
                                <button className="w-8 h-8 bg-gray-300 dark:bg-[#1B1F28] text-black dark:text-white flex justify-center items-center rounded-full">
