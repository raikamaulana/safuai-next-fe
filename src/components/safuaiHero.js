...
export const safuaiHero = () => {
    return (
        <>
            <div className="pt-32 lg:pt-40 pb-28 px-4 sm:px-8 md:px-12 lg:px-28 bg-customLight dark:bg-customDark text-black dark:text-white transition-all duration-500">
                        ...
                        <div className="mt-16">
                            <form>   
                                ...
                                <div className="relative">
                                    ...
                                    <input type="search" id="default-search" class="block w-full sm:w-[489px] p-4 pl-14 font-[Inter] font-normal text-base text-gray-900 rounded-xl focus:ring-2 focus:ring-customPurple focus:border-customPurple dark:bg-customDarkGray bg-white placeholder-gray-600 border-none dark:border dark:border-customDarkGray dark:placeholder-gray-600 dark:text-white dark:focus:ring-customPurple dark:focus:border-customPurple" placeholder="Search Project by Name/Token" required />
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div className="w-full mt-16">
                    <div className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-full">
                        <div className="rounded-xl bg-white dark:bg-customDarkGray">
