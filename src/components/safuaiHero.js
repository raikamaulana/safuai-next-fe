        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 w-full">
          <div className="w-full">
            <p className="font-poppins text-base font-medium leading-6">
              Provable Trust <span className="text-customPurple">For All.</span>
            </p>
            <h1 className="font-inter font-semibold text-3xl mt-4 leading-10 md:max-w-2xl lg:w-auto">
              Detect threats and protect your data with a simple yet powerful
              audit
            </h1>
            <p className="font-inter font-medium text-base leading-7 mt-6">
              Protect your assets across any blockchain network{" "}
              <span className="block">
                with <span className="text-customPurple">SAFU.AI</span>
              </span>
            </p>
              ...
              <form>
                ...
                <div className="relative">
                  ...
                  <input
                    type="search"
                    id="default-search"
                    class="block w-full sm:w-489 p-4 pl-14 font-inter font-normal text-base text-gray-900 rounded-xl focus:ring-2 focus:ring-customPurple focus:border-customPurple dark:bg-customDarkGrey bg-white placeholder-gray-600 border-none dark:border dark:border-customDarkGrey dark:placeholder-gray-600 dark:text-white dark:focus:ring-customPurple dark:focus:border-customPurple"
          ...
          <div className="mt-20 lg:-mt-10 w-full flex items-start lg:justify-end">
            <Image
              src="/images/safuaihero/safuaihero.svg"
              width="430"
              height="339"
              alt="safuai"
              className="block dark:hidden mx-auto lg:mx-0"
            />
            <Image
          ...
          <div className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-full">
            <div className="rounded-xl bg-white dark:bg-customDarkGrey">
              <div className="py-8 pl-7">
                <p className="font-inter font-semibold text-xl text-customPurple leading-6">
                  220+
                </p>
                <p className="mt-3 font-inter text-base font-normal leading-5">
                  Crypto Project
                  <br />
                  Audited
                </p>
