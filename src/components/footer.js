...
export const Footer = () => {
    ...
    return (
        <>
            <section className="lg:px-0 lg:pt-[60px] md:pt-[60px] pt-[20px] transition-all duration-500 bg-grey-100 dark:bg-customDark linear">
                <footer className="pb-2 mx-auto lg:px-[88px] px-7 md:px-16">
                        <div className=" min-w-[110px] md:w-[400px] lg:w-[400px] mb-[49px]">
                            <div className="lg:flex gap-1 mb-3 lg:mb-0 md:flex ">
                                    ...
                                    <p className="font-semibold dark:text-white absolute top-[35px] left-[100px] md:inset-[0px] lg:inset[0px] md:relative lg:relative md:ml-[21px] md:mt-3 lg:mt-3 lg:ml-[21px] text-2xl">SAFU AI</p>
                ...
                <div className="lg:mt-32 md:mt-24 mt-16 w-full flex flex-col items-center lg:py-6 py-4 space-y-5 lg:flex-row lg:space-y-0 bg-customGrey lg:mr-0">
                    <nav className="flex lg:pl-[88px] flex-col items-center justify-center text-black text-white lg:flex-row">
