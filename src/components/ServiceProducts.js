...
export const ServiceProducts = () => {
    return (
        <div className="bg-[#E8ECEF] dark:bg-[#1B1F28] px-4 sm:px-8 md:px-12 lg:px-28 pb-36 min-h-screen overflow-hidden">
            <p className="text-2xl text-center text-[#20262D] dark:text-white my-16 font-semibold">Products</p>
            <div className="lg:flex lg:justify-center">
                <div className='lg:mr-4 mb-11 lg:mb-0'>
                    <div className="bg-white dark:bg-[#363D4C] max-w-md mx-auto lg:mx-0 mb-11 rounded-lg flex">
                    ...
                    <div className="bg-white dark:bg-[#363D4C] max-w-md mx-auto lg:mx-0 rounded-lg flex">
                        <div className="text-[#20262D] dark:text-white">
