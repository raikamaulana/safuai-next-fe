...
export const ToonsBox = () => {
  return (
    <>
      <section className="bg-[#0D1116] w-full lg:pl-36 lg:pr-36 px-2 md:px-20 pb-9">
        <div className=''> 
          <div className='lg:flex md:flex w-full pt-8 mb-6 lg:relative md:relative block'>
            <p className='text-2xl font-semibold text-white lg:mb-0 md:mb-0 mb-4'>TOONSBOX TOKEN</p>

            <button className='border border-white text-white py-2 px-4 lg:absolute md:absolute flex right-0 '><svg width="18" className='mr-3 my-auto' height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='bg-customDark w-full h-[650px] rounded-lg lg:px-11 md:px-11  py-14'>
              <div className='w-52 h-52 rounded-full bg-[#D9D9D9] flex items-center relative mb-10 lg:mx-0 md:mx-0 mx-auto'>
                <svg width="130" height="130" className='mx-auto'>
                  ...
                  <p className='text-white absolute left-[60px]'>AIRobotCEO</p>
              </div>
              <ul className='ml-7'>
