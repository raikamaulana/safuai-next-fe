            ...
            <div className="bg-customLight dark:bg-customSecondDark text-black dark:text-white transition-all duration-500">
                ...
                <div className='max-w-3xl font-[Poppins] font-normal'>
                    ...
                    <div className='grid grid-cols-2 lg:grid-cols-4 gap-3'>
                        <div className='bg-customSecondGray text-white text-center py-3'>Manual Review</div>
                        <div className='bg-customSecondGray text-white text-center py-3'>Static Analysis</div>
                        <div className='bg-customSecondGray text-white text-center py-3'>Dynamic Analysis</div>
                        <div className='bg-customSecondGray text-white text-center py-3'>Symbolic Execution</div>
                        <div className='bg-customSecondGray text-white text-center py-3'>SWC Check</div>
                    </div>
                </div>
                {/* DIV 2 */}
                        ...
                        <div className='w-full font-[Poppins] mt-10 font-medium text-lg'>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-14 mt-8 font-[Poppins] font-normal dark:font-light text-base">
                                <div className="text-center w-36">
                                    <Image src="/images/auditinformation/auditrequest.svg" width="40" height="40" alt="auditrequest" className='mx-auto'/>
                                    <p className="mt-2">Audit Request</p>
                                    <p>2023-10-21</p>
                                </div>
                                <div className="text-center w-36">
                                    <Image src="/images/auditinformation/auditonboard.svg" width="40" height="40" alt="auditrequest" className='mx-auto'/>
                                    <p className="mt-2">Audit Onboard</p>
                                    <p>2023-10-25</p>
                                </div>
                                <div className="text-center w-36">
                                    <Image src="/images/auditinformation/revisionat.svg" width="40" height="40" alt="auditrequest" className='mx-auto'/>
                                    <p className="mt-2">Revision At</p>
                                    <p>2023-10-26</p>
                                </div>
                                <div className="text-center w-36">
                                    <Image src="/images/auditinformation/releaseat.svg" width="40" height="40" alt="auditrequest" className='mx-auto'/>
