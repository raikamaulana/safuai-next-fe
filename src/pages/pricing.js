        ...
        <section className="dark:bg-customDark w-full transition-all duration-500 linear">
            <div className="pt-[120px] md:px-12 lg:px-24 pl-0 pb-[10px]">
                <div className="mb-[44px]">
                    ...
                    <p className="text-center px-4 dark:text-white">Best price for high quality service, audit, kyc, etc</p>
                </div>
                    ...
                    <div className="mx-auto col-span-1 row-span-1 md:col-span-1 md:row-span-1 md:mx-auto md:mr-0 max-w-[285px] h-[465px] max-h-[470px] lg:ml-auto lg:mr-0">
                        <div className="p-4 border rounded-lg border-customPurple">
                            ...
                            <ul className="mb-6">
                                ...
                                <li className="dark:text-white">Free Token Launch Consulting</li>
                                <li className="dark:text-white">Audit Badge On Pinksale</li>
                            </ul>
                            <div className="flex">
                                <button className="w-40 px-0 py-0 font-normal border border-customPurple dark:text-white rounded-lg mr-4">Request Audit</button>
                                <button className="px-4 py-3.5 font-normal border border-customPurple dark:text-white rounded-lg">Info</button>
