...
const AuditRelease = dynamic(() => import('@/components/auditRelease').then((mod) => mod.auditRelease), {
    ssr: false,
});

const AuditInformation = dynamic(() => import('@/components/auditInformation').then((mod) => mod.auditInformation), {
    ssr: false,
});

const ManualAudit = dynamic(() => import('@/components/manualAudit').then((mod) => mod.manualAudit), {
    ssr: false,
});
