...
export default function auditList() {
  ...
  return (
    <>
      <Header />
      {/* <AuditDetail /> */}
      <div className="bg-[#E8ECEF] dark:bg-[#1B1F28] duration-500 pt-32">
        <div className="max-w-max mx-auto">
          <h3 className="text-lg text-[#000000] dark:text-white duration-500 font-medium mb-4 md:mb-4 lg:mb-4 xl:mb-4">
            SAFU AI{" "}
            ...
            <div className="bg-[#26293A] rounded-xl h-64 w-64 px-4 py-6 ring-2 ring-[#5B4C7C]">
              ...
              <div className="bg-[#37384D] rounded-md h-8 pl-3.5 pr-0 py-1 mb-4">
                <span className="inline-flex">
                  <span className="absolute inline-block bg-[#D9D9D9] rounded-sm py-1.5 px-1.5 mx-1 animate-ping" />
                  <span className="relative inline-block bg-[#D9D9D9] rounded-sm py-1.5 px-1.5 mx-1" />
                </span>
                <h3 className="inline-block text-white font-medium pr-3">1</h3>
                <span className="inline-flex">
                  <span className="absolute inline-block bg-[#FFEE51] rounded-sm py-1.5 px-1.5 mx-1 animate-ping" />
                  <span className="relative inline-block bg-[#FFEE51] rounded-sm py-1.5 px-1.5 mx-1" />
                </span>
                <h3 className="inline-block text-white font-medium pr-3">2</h3>
                <span className="inline-flex">
                  <span className="absolute inline-block bg-[#FB8F03] rounded-sm py-1.5 px-1.5 mx-1 animate-ping" />
                  <span className="relative inline-block bg-[#FB8F03] rounded-sm py-1.5 px-1.5 mx-1" />
                </span>
                <h3 className="inline-block text-white font-medium pr-3">3</h3>
                <span className="inline-flex">
                  <span className="absolute inline-block bg-[#FE1A64] rounded-sm py-1.5 px-1.5 mx-1 animate-ping" />
                  <span className="relative inline-block bg-[#FE1A64] rounded-sm py-1.5 px-1.5 mx-1" />
                </span>
                <h3 className="inline-block text-white font-medium pr-3">4</h3>
                <span className="inline-flex">
                  <span className="absolute inline-block bg-[#38F982] rounded-sm py-1.5 px-1.5 mx-1 animate-ping" />
                  <span className="relative inline-block bg-[#38F982] rounded-sm py-1.5 px-1.5 mx-1" />
                </span>
