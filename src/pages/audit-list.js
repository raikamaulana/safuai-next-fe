...
export default function auditList() {
  return (
    <>
      <Header />
      <div className="px-4 sm:px-8 md:px-12 lg:px-28 xl:px-28 pt-32 bg-customWhite dark:bg-customDark transition-all duration-500">
        <h3 className="text-lg text-customFullBlack dark:text-white font-medium mb-4">
          SAFU AI{" "}
